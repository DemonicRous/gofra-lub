            ...
            <div class="max-w-md w-full">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 transition-colors duration-300">
                    ...
                    <div class="mt-6 text-center">
                        <Link :href="route('pages.home')" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">
...
const submit = () => {
    form.post(route('password.confirm'), {
        onError: (errors) => {
            console.error('Ошибка подтверждения пароля:', errors)
        }
    })
}
</script>
